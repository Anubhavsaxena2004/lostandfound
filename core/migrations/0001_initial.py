# Generated by Django 4.2.7 on 2025-04-11 21:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(help_text='Detailed description of the item', validators=[django.core.validators.MinLengthValidator(10)])),
                ...
                ('contact_reward', models.DecimalField(blank=True, decimal_places=2, help_text='Optional reward amount for returning the item', max_digits=8, null=True)),
